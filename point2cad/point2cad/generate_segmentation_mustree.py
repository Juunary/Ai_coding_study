...
# generate_segmentation_mustree.py
import argparse
import os
import numpy as np
...
def infer_impeller(xyz_path, model_path, device, out_dir=None):
...
if __name__=='__main__':
    ...
    if args.mode=='train':
        ...
        infer_impeller(args.xyz_path,args.model_path,dev,args.out_dir)
